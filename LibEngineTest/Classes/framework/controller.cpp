...
public:
    RootTests() {
        addTest("SpriteTtest", []() {
            return new (std::nothrow) SpriteTests();
        });
//        addTest("ActionManager", []() {
//            return new (std::nothrow) ActionManagerTests();
//        });
//        addTest("Actions - Basic", []() {
//            return new (std::nothrow) ActionsTests();
//        });
//        addTest("Actions - Ease", []() {
//            return new (std::nothrow) ActionsEaseTests();
//        });
//        addTest("Actions - Progress", []() {
//            return new (std::nothrow) ActionsProgressTests();
//        });
//        addTest("Allocator - Basic", []() {
//            return new (std::nothrow) AllocatorTests();
//        });
...
//        addTest("Box2d - Basic", []() {
//            return new (std::nothrow) Box2DTests();
//        });
//        addTest("Box2d - TestBed", []() {
//            return new (std::nothrow) Box2dTestBedSuite();
//        });
//#endif
//        addTest("Bugs", []() {
...
//        });
//        addTest("Click and Move", []() {
//            return new ClickAndMoveTest();
//        });
//        addTest("Configuration", []() {
