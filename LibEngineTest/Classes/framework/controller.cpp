...
#include "BaseTest.h"
#include "tests.h"
#include "test/SliderTest/SliderTest.h"
#include "test/SpriteTest/SpriteTest.h"
#include "test/CheckBox/CheckBoxTest.h"
#include "test/LabelTest/LabelTest.h"
#include "test/PVRTest/PVRTest.h"
#include "test/EffectTest/EffectTest.h"
#include "test/ButtonTest/ButtonTest.h"
#include "test/ApplicationTest/ApplicationTest.h"
#include "test/CocosStudioTest/CocosStudioTest.h"
#include "test/SoundTest/SoundTest.h"
#include "test/TableViewTest/TableViewTest.h"
#include "test/CycScrollViewTest/CycScrollViewTest.h"
#include "test/RotateMenuTest/RotateMenuTest.h"
#include "test/ProgressTimerTest/ProgressTimerTest.h"
...
public:
    RootTests() {
        ADD_TEST(SpriteTests);
        ADD_TEST(SliderTests);
        ADD_TEST(CheckBoxTests);
        ADD_TEST(LabelTests);
        ADD_TEST(PVRTests);
        ADD_TEST(EffectTests);
        ADD_TEST(ButtonTests);
        ADD_TEST(ApplicationTests);
        ADD_TEST(CocosStudioTests);
        ADD_TEST(SoundTests);
        ADD_TEST(TableViewTests);
        ADD_TEST(CycScrollViewTests);
        ADD_TEST(RotateMenuTests);
        ADD_TEST(ProgressTimerTests);
    }
};
